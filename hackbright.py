...
def get_project_by_title(title):
    ...
    project_one = cursor.fetchone()

    print "Project Title: ", project_one[1]
    print "Project Desc: ", project_one[2]
    print "Max Grade: ", project_one[3] 
...
def get_grade_by_github_title(github, title):
    ...
    print "{} grade: {}".format(github, grade[0])

def assign_grade(github, title, grade):
    """Assign a student a grade on an assignment and print a confirmation."""
    
    INSERT = """INSERT INTO grades (student_github, project_title, grade)
                    VALUES (:github, :title, :grade)
            """

    db.session.execute(INSERT, {'github': github,
                                'title': title,
                                'grade': grade
                                })
